                ...
                <div class="row g-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-6 col-xxl-5">
                        <div class="login-form">
                            ...
                            <form action="{{ route('user.auth.login') }}" class="row  verify-gcaptcha" method="post"
                                autocomplete="off">
                                @csrf
                                ...
                                <x-captcha googleCaptchaClass="col-12 mb-3" customCaptchaDiv="col-12 mb-3"
                                    customCaptchaCode="mb-3" />

                                <div class="col-sm-6 mb-3">
                                    <div class="form-check form--check">
                                        <input class="form-check-input custom--check" type="checkbox" id="rememberMe"
                                            name="remember" @checked(old('remember')) />
                                        <label class="form-check-label form-label"
                                            for="rememberMe">@lang('Remember Me')</label>
                                    </div>
                                </div>

                                <div class="col-sm-6 mb-3">
                                    <a href="{{ route('user.auth.password.request') }}"
                                ...
                                <div class="col-12 mb-3">
                                    <p class="m-0 sm-text text-center lh-1">
                                        @lang('Don\'t have an account?') <a href="{{ route('user.auth.register') }}"
