...
@section('panel')
    @include('templates.basic.partials.breadcrumb_two')
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="verification-code-wrapper">
                            <div class="verification-area">
                                <form action="{{ route('user.auth.password.verify.code') }}" method="POST"
                                    class="submit-form">
                                    @csrf
                                    ...
                                    @include('templates.basic.partials.verification_code')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a class="t-link t-link--base text--base"
                                            href="{{ route('user.auth.password.request') }}">@lang('Try to send again')</a>
                                    </div>
                                </form>
                            </div>
                        </div>
