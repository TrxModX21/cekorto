...
@if ($style == 2)
    <x-widget-2 :link=$link :title=$title :value=$value :heading=$heading :subheading=$subheading :icon=$icon :bg=$bg
        :color=$color :icon_color=$icon_color :icon_style=$icon_style :overlay_icon=$overlay_icon
        :cover_cursor=$cover_cursor />
@endif
...
@if ($style == 6)
    <x-widget-6 :link=$link :title=$title :value=$value :icon=$icon :bg=$bg :outline=$outline :heading=$heading
        :subheading=$subheading :viewMoreIcon=$viewMoreIcon />
@endif
