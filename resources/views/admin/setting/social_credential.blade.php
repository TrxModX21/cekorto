                                            ...
                                            <div class="button--group">
                                                ...
                                                @if (@$credential->status == Status::ENABLE)
                                                    <button class="btn btn-outline--danger btn-sm confirmationBtn"
                                                        data-question="@lang('Are you sure that you want to disable this login credential?')"
                                                ...
                                                @else
                                                    <button class="btn btn-outline--success btn-sm confirmationBtn"
                                                        data-question="@lang('Are you sure that you want to enable login credential?')"
                                                        data-action="{{ route('admin.setting.socialite.credentials.status.update', $key) }}">
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.editBtn', function() {
                ...
                let callbackUrl = "{{ route('user.auth.social.login.callback', '') }}";
