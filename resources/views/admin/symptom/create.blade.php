...
@section('panel')
    <form action="{{ route('admin.symptom.store') }}" method="POST">
        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="B00"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" rows="2" class="form-control" maxlength="200" placeholder="@lang('Short description for symptom.')">{{ old('description') }}</textarea>
                                </div>
                            </div>
