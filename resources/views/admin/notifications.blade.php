        ...
        @forelse($notifications as $notification)
            <div class="notify-item-wrapper">
                ...
                <button type="button" class="btn btn-sm btn-outline--danger notify-delete-btn confirmationBtn"
                    ...
                    data-action="{{ route('admin.notification.delete.single', $notification->id) }}"><i
...
@push('breadcrumb-plugins')
    @if ($hasUnread)
        <a href="{{ route('admin.notification.read.all') }}" class="btn btn-sm btn-outline--primary"><i
                class="las la-check"></i>@lang('Mark All as Read')</a>
    @endif
    @if ($hasNotification)
        <button class="btn btn-sm btn-outline--danger confirmationBtn"
            data-action="{{ route('admin.notification.delete.all') }}" data-question="@lang('Are you sure to delete all notifications?')"><i
