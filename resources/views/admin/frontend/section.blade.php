                                    ...
                                    @else
                                        @if ($k != 'images')
                                            @if ($item == 'icon')
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label for="{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                                        <div class="input-group">
                                                            <input type="text" id="{{ $k }}"
                                                                class="form-control iconPicker icon" autocomplete="off"
                                                                name="{{ $k }}"
                                            ...
                                            @elseif ($item == 'textarea')
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                                        <textarea class="form-control" name="{{ $k }}" id="{{ $k }}" rows="10">{{ @$content->data_values->$k }}</textarea>
                                                    </div>
                                                </div>
                                            @elseif ($item == 'textarea-nic')
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                                        <textarea rows="10" class="form-control nicEdit" name="{{ $k }}" id="{{ $k }}">{{ @$content->data_values->$k }}</textarea>
                                                    </div>
                                                </div>
                                            @elseif ($k == 'select')
                                                @php
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label
                                                            for="{{ @$selectName }}">{{ __(keyToTitle(@$selectName)) }}</label>
                                            ...
                                            @foreach ($section->element as $k => $type)
                                                @if ($k != 'modal' && $k != 'seo')
                                                    ...
                                                    @elseif($k == 'select')
                                                        ...
                                                        @endphp
                                                        <td>{{ @$section->element->$k->options[@$data->data_values->$dataVal] }}
                                                        </td>
                                                    @endif
                                                @endif
                                            @endforeach
                        ...
                        <div class="modal-body">
                            @foreach ($section->element as $k => $type)
                                @if ($k != 'modal')
                                    @if ($type == 'icon')
                                        <div class="form-group">
                                            <label for="addModal-{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control iconPicker icon"
                                                    autocomplete="off" id="addModal-{{ $k }}"
                                                    name="{{ $k }}" required>
                                    ...
                                    @elseif ($type == 'textarea')
                                        <div class="form-group">
                                            <label for="addModal-{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                            <textarea rows="4" class="form-control" id="addModal-{{ $k }}" name="{{ $k }}"
                                                required></textarea>
                                        </div>
                                    @elseif($type == 'textarea-nic')
                                        <div class="form-group">
                                            <label for="addModal-{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                            <textarea rows="4" class="form-control nicEdit" id="addModal-{{ $k }}"
                                                name="{{ $k }}"></textarea>
                                        </div>
                                    @else
                                        <div class="form-group">
                                            <label for="addModal-{{ $k }}">{{ __(keyToTitle($k)) }}</label>
                                            <input type="text" class="form-control" id="addModal-{{ $k }}"
                                                name="{{ $k }}" required>
                                        </div>
                                    @endif
                                @endif
