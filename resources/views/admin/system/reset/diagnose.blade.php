                    ...
                    <div class="update-available-card border--danger">
                        <div class="update-available-card-bottom">
                            <p>
                                ...
                                <span>
                                    <strong>@lang('You will delete all user diagnostic data.')</strong>
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <span><i class="las la-check-double text--success"></i> @lang('Understand all user diagnose data history will be removed permanently.')</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="card-footer">
                                <button data-question="@lang('Are you sure to reset this data? This process cannot be undo!')"
                                    data-action="{{ route('admin.system.reset.diagnose.data') }}"
