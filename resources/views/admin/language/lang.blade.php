                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn--primary w-100 h-45 mt-3 copyBtn"><i
                                class="las la-copy"></i>
                            <span class="text-white copy-text">@lang('Copy')</span></button>
                    </div>
                </div>
            </div>
        </div>
...
@push('breadcrumb-plugins')
    ...
    <button type="button" class="btn btn-sm btn-outline--info keyBtn" data-bs-toggle="modal"
        data-bs-target="#getLangModal"><i class="las la-code"></i>@lang('Language Keywords')</button>
@endpush
